...
const Contact: React.FC = () => {
  ...
  const faqs = [
    {
      question: 'How do I get started with DevMentors?',
      answer: 'Simply join our community for free and browse our available programs and mentors.'
    },
    {
      question: 'Is mentorship really free?',
      answer: 'Yes! All our mentors volunteer their time to help the next generation of developers.'
    },
    {
      question: 'How long does it take to find a mentor?',
      answer: 'Most learners are matched with a mentor within 1-2 weeks of joining.'
    },
    {
      question: 'Can I become a mentor?',
      answer: 'Absolutely! We welcome experienced developers who want to give back to the community.'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Have questions about our in-person programs, local mentorship, or community? We'd love to hear from you 
              and help you on your software engineering journey.
            </p>
          </div>
        </div>
      </section>
